...
@Form.create()
export default class InventoryDetails extends PureComponent {
  constructor(props){
    super(props);
    // 出事状态
    this.state = {
        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Button icon="plus" type="primary" onClick={this.handleAddAssets.bind(this)}>添加资产</Button>
            </div>
          {/* 表格信息 */}
            <TableList
              loading={false}
        ...
        >
          <Form onSubmit={this.handleSubmit} layout="vertical">
            ...
            <FormItem
              ...
              hasFeedback
            >
              {getFieldDecorator('assetsPrice', {
                initialValue: initEditData.assetsPrice,
                rules: [{
                  required: true, message: '请输入物品价格.',
                },{
                  pattern: /\d/ig,
                  message: '只能输入数字'
                }],
              })(
                <InputNumber placeholder="请输入物品价格" style={{width: '100%'}}/>
              )}
            </FormItem>
            <FormItem
              {...formItemLayout}
